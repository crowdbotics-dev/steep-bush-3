"""
Django settings for steep_bush_3 project.
...
ROOT_URLCONF = 'steep_bush_3.urls'
...
WSGI_APPLICATION = 'steep_bush_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "steep_bush_3 API",
    "DESCRIPTION": "API documentation for steep_bush_3 App",
    "VERSION": "v1",
}
